            ...
            <div className="bg-white p-8 rounded-lg flex-1">
              ...
              <table className="bg-white border-collapse w-full mt-8">
                <tr className="font-medium">
                  ...
                  <th className="text-left px-5 py-4">Full Name</th>
                  <th className="text-left px-5 py-4">Email address</th>
                  <th className="text-left px-5 py-4">Date Subscribed</th>
                  <th className="text-left px-5 py-4 w-[30%]"></th>
                </tr>
                <tr
                ...
                >
                  ...
                  <td className="px-5 py-6">May 16, 2023</td>
                  <td className="px-5 py-6 text-primary cursor-pointer w-[30%]"></td>
                </tr>
                <tr
                  className="hover:bg-[#fefcfc] border-b border-gray3 text-[#5D606B] font-light"
                  tabIndex={0}
